package ch.hackzurich.migrozept.util;
...
import ch.hackzurich.migrozept.ScanditSDKDemo;
import ch.hackzurich.migrozept.ScanditSDKSampleBarcodeActivity;
    ...
    protected void onPostExecute(String result) {
		...
		try {
			...
			if (obj.has("error")) {
				...
				message = obj.getJSONObject("product").getString("name");
			}
			
		} catch (JSONException e) {
			sourceActivity.showToast("Exception");
			e.printStackTrace();
		}
		
		sourceActivity.showToast(message);
		sourceActivity.didManualSearch(result);
